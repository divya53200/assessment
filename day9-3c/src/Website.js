            ...
            <div> 
                ...
                <h2>Our Tours</h2> 
                    ...
                    {  this.state.datas.map((data, index) => <div key={data.id}><div className='b'><img src={data.image} /> 
                        ...
                        <div> 
                            <p >{this.state.read ? data.info : data.info.slice(0, 200)} 
                            <button className='btn btn-secondary' onClick={this.handleToggle}>{this.state.read ? 'Show Less' : 'Read More'}</button>
                            </p> 
                             
 
                        </div> 
                      <center>  <button  className="button btn btn-outline-danger" onClick={() => this.handleDelete(index)}>Not Interested</button></center> 
